...
Нажмите /log_in для входа в аккаунт обычного пользователя, либо /admin для входа в аккаунт администратора
'''
...
bad_password_text = '''
Неверный пароль, нажмите /log_in, чтобы повторить попытку, либо /stop_auth, чтобы выйти
'''
...
Пожалуйста, нажмите /log_in или /admin для авторизации
'''
